...
#pragma warning disable 0649
        ...
        [SerializeField]
        private TextMeshProUGUI newInfoCountTextTMP;
        [SerializeField]
        private TextMeshProUGUI newWarningCountTextTMP;
        [SerializeField]
        private TextMeshProUGUI newErrorCountTextTMP;
...
#pragma warning restore 0649
		...
		{
			newInfoCount++;
			newInfoCountTextTMP.text = newInfoCount.ToString();
		...
		{
			newWarningCount++;
			newWarningCountTextTMP.text = newWarningCount.ToString();
		...
		{
			newErrorCount++;
			newErrorCountTextTMP.text = newErrorCount.ToString();
		...
		private void Reset()
		{
			...
			newInfoCountTextTMP.text = "0";
			newWarningCountTextTMP.text = "0";
			newErrorCountTextTMP.text = "0";
