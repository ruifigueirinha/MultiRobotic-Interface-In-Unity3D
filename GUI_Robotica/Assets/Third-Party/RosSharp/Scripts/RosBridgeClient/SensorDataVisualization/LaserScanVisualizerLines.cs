...
public class LaserScanVisualizerLines : LaserScanVisualizer
{
    ...
    protected override void Visualize()
    {
        ...
        for (int i = 0; i < directions.Length; i++)
        {
            ...
            if (createPCl)// == true && (i % 100 == 0))
                //Gizmos.DrawSphere(lr.GetPosition(1), 0.01f);
                Instantiate(spherePrefab, lr.GetPosition(1), new Quaternion(0, 0, 0, 0));
        }
    }
